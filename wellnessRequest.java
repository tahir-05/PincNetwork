...
public class wellnessRequest {
    ...
    public static void positiveLogin(WebDriver driver) throws InterruptedException {
       ...
       // (By.cssSelector("li.nav-item > button.btn.btn-primary.btn-md.px-1.font-small-3.shadow.round"));
       //"button.btn.btn-primary.btn-md.px-1.font-small-3.shadow.round")
      
       WebElement raiseNewRequestButton =driver.findElement(By.cssSelector("li.nav-item > button.btn.btn-primary.btn-md.px-1.font-small-3.shadow.round"));
